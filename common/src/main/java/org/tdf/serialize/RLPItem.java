...
public final class RLPItem implements RLPElement {
    ...
    public static RLPItem fromLong(long l) {
        ...
        return fromBytes(Bytes.concat(
                // trim zero bytes
                Arrays.copyOfRange(BigEndian.encodeInt64(l), leadingZeroBytes, Long.BYTES)
        ));
    }
    ...
    public long getLong() {
        ...
        longNumber = BigEndian.decodeInt64(Bytes.concat(new byte[Long.BYTES - data.length], data));
        return longNumber;
    }
