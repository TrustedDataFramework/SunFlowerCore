...
import org.wisdom.gmhelper.SM2KeyExchangeUtil;
...
public class SM2 {
    ...
    public static byte[] calculateShareKey(boolean initiator, byte[] privStatic, byte[] privEphemeral, byte[] publicKeyStatic, byte[] publicEphemeral, byte[] userId) {
        ...
        return SM2KeyExchangeUtil.calculateKey(initiator, KEY_BITS, skpStatic, skpEphemeral, "userid@soie-chain.com".getBytes(),
