...
public class BCECUtil {
    ...
    public static ECPublicKeyParameters createECPublicKeyParameters(byte[] encodePubkey, ECCurve curve, ECDomainParameters domainParameters) {
        return new ECPublicKeyParameters(curve.decodePoint(encodePubkey), domainParameters);
    }
