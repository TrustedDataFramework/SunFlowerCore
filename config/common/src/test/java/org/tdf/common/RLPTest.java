...
import static org.tdf.serialize.RLPItem.*;
...
public class RLPTest {
    ...
    public void testTransaction() {
        ...
        byte[] encoded = RLPSerializer.SERIALIZER.serialize(t);
        Transaction t2 = RLPDeserializer.deserialize(encoded, Transaction.class);
        Transaction t3 = Transaction.builder()
                ...
                .gasPrice(-1)
                .amount(-1)
                .payload(new HexBytes())
                .to(new HexBytes())
                .signature(new HexBytes())
                .hash(new HexBytes()).build();
        RLPElement element = RLPElement.encode(t3);
        encoded = RLPSerializer.SERIALIZER.serialize(t3);
        Transaction t4 = RLPDeserializer.deserialize(encoded, Transaction.class);
        assertEquals(t4.getVersion(), -1);
        assertEquals(t4.getType(), -1);
        assertEquals(t4.getCreatedAt(), -1);
        assertEquals(t4.getNonce(), -1);
        assertEquals(t4.getFrom(), null);
        assertEquals(t4.getGasPrice(), -1);
        assertEquals(t4.getAmount(), -1);
        assertEquals(t4.getPayload(), null);
        assertEquals(t4.getTo(), null);
    }
    ...
    public void testHeader() throws Exception {
        Header h = Header.builder()
                .version(-1)
                .hashPrev(new HexBytes("aaff"))
                .merkleRoot(new HexBytes("ffaa"))
                .height(-1)
                .createdAt(Long.MAX_VALUE)
                .payload(new HexBytes("ccdd"))
                .hash(new HexBytes("eeff"))
                .build();
        Header h2 = RLPDeserializer.deserialize(RLPSerializer.SERIALIZER.serialize(h), Header.class);
        assertEquals(h2.getVersion(), -1);
        assertEquals(h2.getHashPrev(), new HexBytes("aaff"));
        assertEquals(h2.getMerkleRoot(), new HexBytes("ffaa"));
        assertEquals(h2.getHeight(), -1);
        assertEquals(h2.getCreatedAt(), Long.MAX_VALUE);
        assertEquals(h2.getPayload(), new HexBytes("ccdd"));
        assertEquals(h2.getHash(), new HexBytes("eeff"));
    }
    ...
    public void testBlock() throws Exception {
        ...
        Transaction t = Transaction.builder()
                ...
                .createdAt(-1)
                .nonce(-1)
                .from(new HexBytes("aabb"))
                .gasPrice(-1)
                .amount(-1)
                .payload(new HexBytes("ccdd"))
                .to(new HexBytes("eeff"))
                .signature(new HexBytes("aaaa"))
                .hash(new HexBytes()).build();
        ...
        b.setBody(all);
        byte[] data = RLPSerializer.SERIALIZER.serialize(b);
        Block b2 = RLPDeserializer.deserialize(data, Block.class);
    ...
    public void test8() throws Exception {
        ...
        byte[] byteArray = HexBytes.parse(byteArr).getBytes();
    ...
    public void testEncode_ED() {
        String result = Hex.toHexString(encodeInt(0xED));
